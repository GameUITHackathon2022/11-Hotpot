...
var _a2;
var ERROR_MAP = (_a2 = {}, _a2["missing-app-config-values"] = 'Missing App configuration value: "{$valueName}"', _a2["only-available-in-window"] = "This method is available in a Window context.", _a2["only-available-in-sw"] = "This method is available in a service worker context.", _a2["permission-default"] = "The notification permission was not granted and dismissed instead.", _a2["permission-blocked"] = "The notification permission was not granted and blocked instead.", _a2["unsupported-browser"] = "This browser doesn't support the API's required to use the firebase SDK.", _a2["failed-service-worker-registration"] = "We are unable to register the default service worker. {$browserErrorMessage}", _a2["token-subscribe-failed"] = "A problem occurred while subscribing the user to FCM: {$errorInfo}", _a2["token-subscribe-no-token"] = "FCM returned no token when subscribing the user to push.", _a2["token-unsubscribe-failed"] = "A problem occurred while unsubscribing the user from FCM: {$errorInfo}", _a2["token-update-failed"] = "A problem occurred while updating the user from FCM: {$errorInfo}", _a2["token-update-no-token"] = "FCM returned no token when updating the user to push.", _a2["use-sw-after-get-token"] = "The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.", _a2["invalid-sw-registration"] = "The input to useServiceWorker() must be a ServiceWorkerRegistration.", _a2["invalid-bg-handler"] = "The input to setBackgroundMessageHandler() must be a function.", _a2["invalid-vapid-key"] = "The public VAPID key must be a string.", _a2["use-vapid-key-after-get-token"] = "The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used.", _a2);
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          try {
            ...
            try {
              if (clientList_1_1 && !clientList_1_1.done && (_a3 = clientList_1.return))
                _a3.call(clientList_1);
            } finally {
              if (e_1)
                throw e_1.error;
            }
...
function sendMessagePayloadInternalToWindows(clientList, internalPayload) {
  ...
  try {
    ...
    try {
      if (clientList_2_1 && !clientList_2_1.done && (_a3 = clientList_2.return))
        _a3.call(clientList_2);
    } finally {
      if (e_2)
        throw e_2.error;
    }
...
function showNotification(notificationPayloadInternal) {
  ...
  return self.registration.showNotification((_a3 = notificationPayloadInternal.title) !== null && _a3 !== void 0 ? _a3 : "", notificationPayloadInternal);
}
